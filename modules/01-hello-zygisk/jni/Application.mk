...
# c++_static (not c++_shared) is used so libzygisklab.so stays self-contained:
# c++_shared would require shipping a separate libc++_shared.so in the
# package, which build.sh does not package.
APP_STL      := c++_static
