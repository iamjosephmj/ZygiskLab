// Vendored from https://github.com/topjohnwu/zygisk-module-sample
// (module/jni/zygisk.hpp @ master), the official Zygisk C++ API sample.
// Targets ZYGISK_API_VERSION 5. Fetched 2026-08-31. Unmodified below this line.
//
